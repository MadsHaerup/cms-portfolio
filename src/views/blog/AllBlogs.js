		...
		async function FetchAllBlogs() {
			try {
				const response = await axios.get(
					`https://api.cosmicjs.com/v2/buckets/${cosmicBucketSlug}/objects?pretty=true&query=%7B%22type%22%3A%22blogs%22%7D&read_key=${cosmicReadKey}&limit=20&props=slug,metadata`
				);
